$(document).ready(function(){
  ...
  // stavlja ime kategorije u input formu gde se menja ime
    $("#category_chose").click(function(){
      var category=$(".select_category_manage").val();
      if(category!="")
      {
        $.ajax({
    ...
    $("#category_change").click(function(){
      if($("#category_manage").val()!="")
      {
        ...
        {
          $.post("category_manage.php?funkcija=change", {categories_id: $(".select_category_manage").val(),category_manage: $("#category_manage").val()}, function(response){
            alert("sacekaj");
            location.reload();
